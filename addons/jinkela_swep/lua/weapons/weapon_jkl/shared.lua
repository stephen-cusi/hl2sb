-- 金坷垃武器移植来着gmos
SWEP.Name = "Paprika Crisps"

SWEP.printname				= "Paprika Crisps"
SWEP.viewmodel				= "models/Weapons/v_paprika.mdl"
SWEP.playermodel			= "models/Crisps/paprika.mdl"
SWEP.viewmodelfov           =  65
SWEP.anim_prefix			= "python"
SWEP.bucket					= 1
SWEP.bucket_position		= 1

SWEP.clip_size				= 9999999999
SWEP.clip2_size				= -1
SWEP.default_clip			= 9999999999
...
--/SWEP CREATED BY MR. DINNERMAU5 GARRYS MOD